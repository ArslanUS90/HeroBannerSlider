...
namespace ArslanFarrukh\HeroBannerSlider\Controller\Adminhtml\Index;
...
class Edit extends Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'ArslanFarrukh_HeroBannerSlider::edit';
    ...
    public function execute()
    {
        ...
        if ($isExistingBanner) {
            ...
            $this->dataPersistor->set('arslan_hero_banner', $heroBanner);
        }

        /** @var Page $resultPage */
        $resultPage = $this->resultFactory->create(ResultFactory::TYPE_PAGE);
        $resultPage->setActiveMenu('ArslanFarrukh_HeroBannerSlider::edit');
    ...
    protected function _isAllowed()
    {
        ...
        $isExistingBanner = (bool)$bannerId;
        if ($isExistingBanner) {
            return $this->_authorization->isAllowed('ArslanFarrukh_HeroBannerSlider::edit');
        }
        return $this->_authorization->isAllowed('ArslanFarrukh_HeroBannerSlider::add');
    }
}
