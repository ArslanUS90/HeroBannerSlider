...
namespace ArslanFarrukh\HeroBannerSlider\Model;
...
class HeroBanner extends AbstractModel implements HeroBannerInterface, IdentityInterface
{
    ...
    /** CMS page cache tag */
    const CACHE_TAG = 'arslan_herobanner';

    /** Cache tag */
    protected $cacheTag = 'arslan_herobanner';

    /** Prefix of model banner names */
    protected $eventPrefix = 'arslan_herobanner';
