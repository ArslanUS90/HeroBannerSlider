...
namespace ArslanFarrukh\HeroBannerSlider\Model\HeroBanner;
...
use ArslanFarrukh\HeroBannerSlider\Model\HeroBannerFactory;
use ArslanFarrukh\HeroBannerSlider\Model\Repository\HeroBannerRepository;
use ArslanFarrukh\HeroBannerSlider\Model\ResourceModel\HeroBanner\CollectionFactory;
use ArslanFarrukh\HeroBannerSlider\Model\Uploader;
...
class DataProvider extends ModifierPoolDataProvider
{
     ...
     */
    const FILE_TMP_PATH = 'arslan_herobanner/tmp/slider/file';
    const FILE_PATH = 'arslan_herobanner/slider/file';
    /**#@-*/
    ...
    private function getCurrentHeroBanner(): HeroBannerInterface
    {
        ...
        $data = $this->dataPersistor->get('arslan_hero_banner');
        if (empty($data)) {
            return $this->heroBannerFactory->create();
        }
        $this->dataPersistor->clear('arslan_hero_banner');
