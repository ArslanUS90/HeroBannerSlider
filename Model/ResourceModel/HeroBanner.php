...
namespace ArslanFarrukh\HeroBannerSlider\Model\ResourceModel;
...
{
    const MAIN_TABLE = "arslan_herobanner";
    ...
    protected function _getLoadByIdentifierSelect($identifier, $store, $isActive = null)
    {
        ...
        $select = $this->getConnection()->select()
            ...
            ->join(
                ['cps' => $this->getTable('arslan_herobanner_store')],
    ...
    public function lookupStoreIds($bannerId)
    {
        ...
        $select = $connection->select()
            ->from(['cps' => $this->getTable('arslan_herobanner_store')], 'store_id')
            ->join(
    ...
    public function lookupCustomerGroupIds($bannerId)
    {
        ...
        $select = $connection->select()
            ->from(['cps' => $this->getTable('arslan_herobanner_customer_group')], 'customer_group_id')
            ->join(
                ['cp' => $this->getMainTable()],
                'cps.' . $linkField . ' = cp.' . $linkField,
                []
