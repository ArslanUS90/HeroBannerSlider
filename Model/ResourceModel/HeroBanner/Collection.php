...
namespace ArslanFarrukh\HeroBannerSlider\Model\ResourceModel\HeroBanner;

use Exception;
use Magento\Framework\Exception\NoSuchEntityException;
use ArslanFarrukh\HeroBannerSlider\Api\Data\HeroBannerInterface;
use ArslanFarrukh\HeroBannerSlider\Model\HeroBanner;
use ArslanFarrukh\HeroBannerSlider\Model\ResourceModel\AbstractCollection;
use ArslanFarrukh\HeroBannerSlider\Model\ResourceModel\HeroBanner as HeroBannerResource;
...
class Collection extends AbstractCollection
{
    ...
    public function addFieldToFilter($field, $condition = null)
    {
        switch ($field) {
            case "store":
                ...
                $this->getSelect()->join(
                    ['store' => $this->getTable('arslan_herobanner_store')],
            ...
            case "customer":
                ...
                $this->getSelect()->join(
                    ['customer' => $this->getTable('arslan_herobanner_customer_group')],
    ...
    {
        $this->join(
            ['banner_store' => $this->getTable('arslan_herobanner_store')],
    ...
    protected function _afterLoad()
    {
        ...
        $this->performAfterLoad($this->getTable('arslan_herobanner_store'), $entityMetadata->getLinkField());
    ...
    {
        $entityMetadata = $this->metadataPool->getMetadata(HeroBannerInterface::class);
        $this->joinStoreRelationTable($this->getTable('arslan_herobanner_store'), $entityMetadata->getLinkField());
    }
}
