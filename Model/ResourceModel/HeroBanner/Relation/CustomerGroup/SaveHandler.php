...
namespace ArslanFarrukh\HeroBannerSlider\Model\ResourceModel\HeroBanner\Relation\CustomerGroup;

use Exception;
use Magento\Framework\EntityManager\Operation\ExtensionInterface;
use ArslanFarrukh\HeroBannerSlider\Api\Data\HeroBannerInterface;
use ArslanFarrukh\HeroBannerSlider\Model\ResourceModel\HeroBanner;
...
class SaveHandler implements ExtensionInterface
{
    ...
    public function execute($entity, $arguments = [])
    {
        ...
        $table = $this->resourceBanner->getTable('arslan_herobanner_customer_group');
